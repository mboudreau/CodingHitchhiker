...
if(Modernizr.csstransitions){$.fn.trans=function(){var t=arguments[0],d=arguments[1]||"";if(t)$.each(this,function(i,e){$(["-webkit-","-moz-","-o-","-ms-",""]).each(function(i,p){$(e).css(p+"transition"+d,t)})})};$(function(){$(".animate-post").appear({once:true,forEachVisible:function(i,e){$(e).data("delay",i)},appear:function(){var delay=200,stagger=100,sequential_delay=stagger*
